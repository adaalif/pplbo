...
if (isset($_POST['submit']) && isset($_POST['pilihan_kelas'])) {
    ...
    // Setelah pemilihan berhasil, beri pesan kepada pengguna dan alihkan ke dashboard
echo "<script>alert('Berhasil memilih mata kuliah'); window.location.href = 'dashboard.html';</script>"; 
exit(); // Hentikan eksekusi skrip

} else {
    // Jika tidak ada data yang dipost, alihkan pengguna kembali ke halaman mata_kuliah.php
