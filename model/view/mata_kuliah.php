...
<div class="container">
        ...
        <section class="main">
          ...
          <div class="main-body">
          <table class="table">
<h2 class="h2">Daftar Mata Kuliah</h2>
    <thead>
        <tr>
            <th>Pilih</th>
            <th>Kode Kelas</th>
    ...
    <?php endif; ?>
          ...
          <button class="button-6" role="button"><a href="../login/dashboard"> return</a></button>
        </div>

        <div class="button-wrapper" data-tippy-content="Click to copy button 6">
          <button class="button-6" role="button"><a href="../login/dashboard"><a href="pilih_mk"> Pilih Mata Kuliah</a></a></button>
        </div>
